    ...
    return {
	  ...
	  $scope.$watch('url', function(newValue, oldValue) {
            ...
            if(oldValue != undefined){
                ...
                var iframe = '<iframe width=100% height=500px src="https://www.youtube.com/embed/' + ytId + '?autoplay=' + autoplay + '&autohide=' + autohide + '&cc_load_policy=' + ccloadpolicy + '&color=' + color + '&controls=' + controls + '&disablekb=' + disablekb + '&end=' + end + '&fs=' + fs + '&hl=' + hl + '&playlist=' + playlist + '&playsinline=' + playsinline + '&rel=' + rel + '&showinfo=' + showinfo + '&start=' + start + '&theme=' + theme + '" frameborder="0" allowfullscreen></iframe>';
            ...
            if (link != undefined) {
                ...
                // Creating iframe for video playback
                var iframe = '<iframe width='+width+' height=500px src="https://www.youtube.com/embed/' + ytId + '?autoplay=false&autohide=' + autohide + '&cc_load_policy=' + ccloadpolicy + '&color=' + color + '&controls=' + controls + '&disablekb=' + disablekb + '&end=' + end + '&fs=' + fs + '&hl=' + hl + '&playlist=' + playlist + '&playsinline=' + playsinline + '&rel=' + rel + '&showinfo=' + showinfo + '&start=' + start + '&theme=' + theme + '" frameborder="0" allowfullscreen></iframe>';
                // Sanitizing and rendering iframe
                $scope.youtubeEmbedFrame = $sce.trustAsHtml(iframe);
            }
        }]
